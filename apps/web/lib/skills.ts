...
export const SKILLS: Record<string, SkillCopy> = {
  ...
  "heart-10": {
    kind: "被动",
    l0: "受罚时改成「链上几张牌就掷几颗骰」摸牌",
    l1: "被 +2/+4 指到时，不再按累计张数摸牌，而是数这串链上有几张 +2/+4，就掷几颗三面骰（每颗 0/1/2），点数之和就是你摸的张数——可能一张都不摸。掷出来的数说了算，别人减你的、加你的一概不作数。",
  },
  "heart-5": {
    kind: "被动",
    l0: "无牌可出时可以不摸牌，直接结束回合",
    l1: "只有这五种情形你**一定要**摸牌：受到惩罚、打出毒、受到别人的技能、打出的最后一张是非数字牌、只剩一张没喊 UNO。除此之外的摸牌你都可以不摸——轮到你却一张打不出时可以直接过，其他非强制的摸牌会先问你一句。手牌超过 10 张时，你还能在别人的回合主动亮出它。",
  },
  "heart-6": {
    kind: "被动",
